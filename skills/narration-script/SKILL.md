...
1. **Goal** — what we're about to do and why ("To share this, we'll create a public link.").
2. **Action** — the single concrete instruction ("Open the **Share** menu and choose **Anyone with the link**.").
3. **Confirmation** — what success looks like ("You'll see the link turn green when it's ready.").
